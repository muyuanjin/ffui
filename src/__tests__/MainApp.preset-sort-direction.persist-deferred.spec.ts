...
describe("MainApp preset sort direction persistence", () => {
  it("persists preset sort direction without relying on requestIdleCallback", async () => {
