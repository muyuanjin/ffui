...
const emit = defineEmits<{
  (e: "open-detail", batch: CompositeBatchCompressTask): void;
  (e: "toggle-select", batchId: string): void;
  (e: "contextmenu-batch", payload: { batch: CompositeBatchCompressTask; event: MouseEvent }): void;
}>();
...
const folderName = computed(() => {
  ...
  if (!raw) return t("batchCompress.title") as string;
