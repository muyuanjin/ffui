...
const basePreset: FFmpegPreset = {
  id: "preset-1",
  name: "Test Preset",
  description: "Preset used in QueuePanel Batch Compress icon batch tests",
  video: {
    encoder: "libx264",
    rateControl: "crf",
    qualityValue: 23,
...
const createBatch = (jobs: TranscodeJob[]): CompositeBatchCompressTask => ({
  batchId: "batch-1",
  rootPath: "C:/videos",
  jobs,
...
describe("QueuePanel Batch Compress icon batch interactions", () => {
