...
import QueueSmartScanIconBatchItem from "@/components/QueueSmartScanIconBatchItem.vue";
import en from "@/locales/en";
import type { CompositeSmartScanTask, TranscodeJob } from "@/types";
...
describe("QueueSmartScanIconBatchItem", () => {
  describe("选中功能", () => {
