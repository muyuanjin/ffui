const other = {
  ...
  taskDetail: {
    ...
    failureReasonMissingEncoderLine1: "当前 FFmpeg 不支持编码器：{encoder}。",
    failureReasonMissingDecoderLine1: "当前 FFmpeg 不支持解码器：{decoder}。",
    failureReasonMissingFilterLine1: "当前 FFmpeg 不支持滤镜：{filter}。",
    failureReasonMissingLibraryLine1: "缺少依赖库：{library}（FFmpeg 无法加载）。",
    failureReasonInputNotFound: "输入文件不存在或路径不可访问。",
    failureReasonPermissionDenied: "权限不足，无法读写文件/目录。",
    failureReasonUnknown: "运行失败，请查看详细错误信息与日志。",
    failureReasonLinePreset: "预设：{presetName}",
    failureReasonLinePresetEncoder: "预设编码器：{encoder}",
    failureReasonLineFfmpeg: "使用的 FFmpeg：{ffmpegPath}",
    failureReasonActionSwitchFfmpeg: "在设置 → 工具中更换 FFmpeg（需包含对应能力）。",
    failureReasonActionChangePreset: "改用其它编码器/预设后重试。",
    failureReasonActionCheckPaths: "检查输入/输出路径是否存在、可写，以及是否被占用。",
    failureReasonActionCheckDetails: "展开并复制详细错误信息用于排查/反馈。",
    failureReasonShowDetails: "查看详细错误",
    failureReasonHideDetails: "隐藏详细错误",
    measureVmaf: "VMAF（30秒）",
    measureVmafHint: "计算前 30 秒 VMAF 均值（输入 vs 输出），并合并到预设统计。",
    measureVmafDisabled: {
      "no-job": "未找到任务。",
      "not-tauri": "仅桌面版（Tauri）可用。",
      "not-video": "仅视频任务支持 VMAF。",
      "not-completed": "仅已完成任务可测量 VMAF。",
      "missing-input": "缺少输入路径，无法测量 VMAF。",
      "missing-output": "缺少输出路径，无法测量 VMAF。",
    },
  },
  // 任务详情对话框（拆分为多个标签页使用）
  jobDetail: {
  ...
  presets: {
    ...
    vmafTooltipPredicted: "预测：{value}",
    vmafMeasureOpen: "测量 VMAF",
    vmafMeasureTitle: "测量预设 VMAF",
    vmafMeasureDescription:
      "选择一个参考视频（可下载示例），用所选预设编码后计算 VMAF，并合并到预设统计（count/mean/min/max）。",
    vmafMeasureAboutTitle: "关于 VMAF（是什么 / 适用范围 / 注意事项）",
    ...
    vmafMeasureLinkAvtVqdbAppeal: "AVT-VQDB-UHD-1-Appeal（含 VMAF JSON）",
    vmafMeasureVideoLabel: "参考视频",
    vmafMeasureDownloadSample: "下载/复用示例视频",
    vmafMeasureDownloadingSample: "正在准备示例视频…",
    vmafMeasureSampleReady: "示例视频已就绪。",
    vmafMeasurePickVideo: "选择本地视频",
    vmafMeasurePickTitle: "选择用于 VMAF 的参考视频",
    vmafMeasureNoVideo: "未选择视频",
    vmafMeasureTrimSeconds: "截取秒数",
    vmafMeasureTrimHint: "默认 30；留空/≤0 表示不截取。",
    vmafMeasurePresetsLabel: "预设（已选 {count}）",
    vmafMeasureSelectSmart: "只选内置",
    vmafMeasureSelectAll: "全选",
    vmafMeasureSelectNone: "全不选",
    vmafMeasureRun: "开始测量",
    vmafMeasureRunningProgress: "正在测量：{n}/{total}",
    vmafMeasureDone: "测量完成。",
    vmafMeasureFailed: "测量失败",
    vmafMeasureErrorMissingEncoderLine1: "当前 FFmpeg 不支持编码器：{encoder}。",
    vmafMeasureErrorMissingEncoderLinePreset: "受影响预设：{presetId}。",
    vmafMeasureErrorMissingEncoderLineFfmpeg: "使用的 FFmpeg：{ffmpegPath}",
    vmafMeasureErrorMissingFilterLine1: "当前 FFmpeg 不支持滤镜：{filter}（VMAF 需要 libvmaf）。",
    vmafMeasureErrorMissingFilterGenericLine1: "当前 FFmpeg 不支持滤镜：{filter}。",
    vmafMeasureErrorMissingDecoderLine1: "当前 FFmpeg 不支持解码器：{decoder}。",
    vmafMeasureErrorMissingLibraryLine1: "缺少依赖库：{library}（FFmpeg 无法加载）。",
    vmafMeasureErrorInputNotFound: "参考视频不存在或路径不可访问。",
    vmafMeasureErrorPermissionDenied: "权限不足，无法读取参考视频或写入临时输出。",
    vmafMeasureErrorUnknown: "发生未知错误，请查看详细错误信息。",
    vmafMeasureErrorActionSwitchFfmpeg: "在工具设置中更换包含所需编码器/滤镜的 FFmpeg（或使用系统 FFmpeg）。",
    vmafMeasureErrorActionUnselectPreset: "取消选择该预设，或改用其它编码器的预设再测量。",
    vmafMeasureErrorActionSwitchFfmpegWithVmaf: "更换为包含 libvmaf 的 FFmpeg 版本后再测量。",
    vmafMeasureErrorActionCheckPaths: "检查参考视频路径是否存在、可读，以及临时目录是否可写。",
    vmafMeasureErrorActionCheckDetails: "查看并复制详细错误信息，用于排查/反馈。",
    vmafMeasureErrorShowDetails: "查看详细错误",
    vmafMeasureErrorHideDetails: "隐藏详细错误",
    footerLabels: {
      avgSizeFull: "平均大小",
      avgSizeShort: "大小",
      fps: "FPS",
