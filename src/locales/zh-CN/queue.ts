const queue = {
  ...
  skipReasons: {
    ...
    alreadyTargetFormat: "已是 {format} 格式",
    existingTargetSibling: "已有同名 {format} 文件",
  ...
  feedback: {
    ...
    bulkWait: {
      successTitle: "批量暂停",
      successDescription:
        "选中 {selected}，已发送暂停请求 {eligible}（排队 {queued} 将立刻暂停，处理中 {processing} 暂停中…），已忽略 {ignored}。",
      noneTitle: "批量暂停",
      noneDescription: "选中 {selected}，没有可暂停的任务（仅支持排队/处理中）。",
      errorTitle: "批量暂停失败",
    },
    bulkResume: {
      successTitle: "批量继续",
      successDescription: "选中 {selected}，已继续 {count}，已忽略 {ignored}。",
      noneTitle: "批量继续",
      noneDescription: "选中 {selected}，没有处于暂停状态的任务。",
      errorTitle: "批量继续失败",
    },
    bulkCancel: {
      successTitle: "批量取消",
      successDescription: "选中 {selected}，已取消 {count}，已忽略 {ignored}。",
      noneTitle: "批量取消",
      noneDescription: "选中 {selected}，没有可取消的任务（仅支持排队/暂停/处理中）。",
      errorTitle: "批量取消失败",
    },
    bulkRestart: {
      successTitle: "批量重新开始",
      successDescription: "选中 {selected}，已重新开始 {count}，已忽略 {ignored}。",
      noneTitle: "批量重新开始",
      noneDescription: "选中 {selected}，没有可重新开始的任务（已完成/已跳过不可重开）。",
      errorTitle: "批量重新开始失败",
    },
    bulkMoveToTop: {
      successTitle: "移到队首",
      successDescription: "选中 {selected}，已移动 {count}，已忽略 {ignored}。",
      noneTitle: "移到队首",
      noneDescription: "选中 {selected}，没有等待中的任务（仅支持排队/暂停）。",
      errorTitle: "调整队列顺序失败",
    },
    bulkMoveToBottom: {
      successTitle: "移到队尾",
    ...
    bulkDelete: {
      successTitle: "从列表中删除",
      successDescription: "选中 {selected}，已移除 {deleted}，已忽略 {ignored}。",
      noneTitle: "从列表中删除",
      noneDescription: "选中 {selected}，没有可移除的终态任务（已完成/失败/已取消/已跳过）。",
      partialTitle: "部分移除",
      partialDescription: "选中 {selected}，已移除 {deleted}。终态可移除 {eligible}，已忽略 {ignored}。",
      errorTitle: "移除失败",
    },
  },
  startupHint: {
    ...
    action: "恢复队列",
    actionResumeTranscoding: "一键恢复转码",
    dismiss: "暂不恢复",
    close: "关闭",
    resuming: "正在恢复暂停任务…",
  },
  error: {
    ...
    autoCompressFailed: "批量压缩启动失败。请检查外部工具是否可用，或在「软件设置」中启用自动下载后重试。",
