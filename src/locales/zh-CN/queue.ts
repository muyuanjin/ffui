const queue = {
  ...
  feedback: {
    bulkWait: {
      successTitle: "批量暂停",
      successDescription: "队列 {queued}，处理中 {processing}，已忽略 {ignored}。",
      noneTitle: "批量暂停",
      noneDescription: "选中项中没有可暂停的任务（仅支持排队/处理中）。",
      errorTitle: "批量暂停失败",
    },
    bulkResume: {
      successTitle: "批量继续",
      successDescription: "已继续 {count}，已忽略 {ignored}。",
      noneTitle: "批量继续",
      noneDescription: "选中项中没有处于暂停状态的任务。",
      errorTitle: "批量继续失败",
    },
    bulkCancel: {
      successTitle: "批量取消",
      successDescription: "已取消 {count}，已忽略 {ignored}。",
      noneTitle: "批量取消",
      noneDescription: "选中项中没有可取消的任务（仅支持排队/暂停/处理中）。",
      errorTitle: "批量取消失败",
    },
    bulkRestart: {
      successTitle: "批量重新开始",
      successDescription: "已重新开始 {count}，已忽略 {ignored}。",
      noneTitle: "批量重新开始",
      noneDescription: "选中项中没有可重新开始的任务（已完成/已跳过不可重开）。",
      errorTitle: "批量重新开始失败",
    },
    bulkMoveToTop: {
      successTitle: "移到队首",
      successDescription: "已移动 {count}，已忽略 {ignored}。",
      noneTitle: "移到队首",
      noneDescription: "选中项中没有等待中的任务（仅支持排队/暂停）。",
      errorTitle: "调整队列顺序失败",
    },
    bulkMoveToBottom: {
      successTitle: "移到队尾",
    ...
    bulkDelete: {
      successTitle: "从列表中删除",
      successDescription: "已移除 {deleted}，已忽略 {ignored}。",
      noneTitle: "从列表中删除",
      noneDescription: "选中项中没有可移除的终态任务（已完成/失败/已取消/已跳过）。",
      partialTitle: "部分移除",
      partialDescription: "已移除 {deleted}。选中的终态 {eligible}，已忽略 {ignored}。",
      errorTitle: "移除失败",
    },
  },
  startupHint: {
