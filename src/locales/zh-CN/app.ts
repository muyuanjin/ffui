const app = {
  ...
  settings: {
    ...
    presetCardFooterTitle: "参数预设底栏",
    presetCardFooterDescription: "切换底栏是一栏还是两栏；显示项与顺序在“详细设置”中配置（重启后保留）。",
    presetCardFooterLayoutTwoRows: "两栏",
    presetCardFooterLayoutOneRow: "一栏",
    presetCardFooterLayoutButton: "布局：{layout}",
    presetCardFooterDetailOpen: "详细设置…",
    presetCardFooterDetailTitle: "参数预设底栏 · 详细设置",
    presetCardFooterDetailDescription: "自定义底栏显示项与显示顺序。",
    presetCardFooterDetailItemsTitle: "显示项与顺序",
    presetCardFooterDetailDragHint: "拖拽左侧图标以调整顺序。",
    presetCardFooterItemAvgSize: "平均大小",
    presetCardFooterItemFps: "FPS",
    presetCardFooterItemVmaf: "VMAF",
    presetCardFooterItemUsedCount: "已用次数",
    presetCardFooterItemDataAmount: "数据量",
    presetCardFooterItemThroughput: "处理速度",
    ...
    networkProxyUrlHint:
      "支持 HTTP/HTTPS 与 SOCKS5 代理（例如 http://host:port 或 socks5://host:port）。修改后会立即生效。",
