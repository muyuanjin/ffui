const app = {
  ...
  settings: {
    ...
    previewCacheSectionTitle: "预览缓存",
    previewCacheSectionDescription: "管理预览图与拖动预览帧缓存（存放在应用的 previews 目录）。",
    ...
    dataRootDesktopHint: "数据管理操作仅在桌面版生效。",
    communityTitle: "开源信息",
