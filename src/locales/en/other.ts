...
const other = {
  ...
  taskDetail: {
    ...
    failureReasonMissingEncoderLine1: "This FFmpeg does not support the encoder: {encoder}.",
    failureReasonMissingDecoderLine1: "This FFmpeg does not support the decoder: {decoder}.",
    failureReasonMissingFilterLine1: "This FFmpeg does not support the filter: {filter}.",
    failureReasonMissingLibraryLine1: "Missing dependency: {library} (FFmpeg cannot load it).",
    failureReasonInputNotFound: "The input file does not exist or the path is not accessible.",
    failureReasonPermissionDenied: "Permission denied when reading/writing files or folders.",
    failureReasonUnknown: "Transcode failed. Check the detailed error output and logs.",
    failureReasonLinePreset: "Preset: {presetName}",
    failureReasonLinePresetEncoder: "Preset encoder: {encoder}",
    failureReasonLineFfmpeg: "FFmpeg in use: {ffmpegPath}",
    failureReasonActionSwitchFfmpeg: "Switch FFmpeg in Settings → Tools (it must include the required features).",
    failureReasonActionChangePreset: "Try another preset/encoder.",
    failureReasonActionCheckPaths: "Check input/output paths, write permissions, and file locks.",
    failureReasonActionCheckDetails: "Expand and copy the detailed error output for troubleshooting/reporting.",
    failureReasonShowDetails: "Show details",
    failureReasonHideDetails: "Hide details",
