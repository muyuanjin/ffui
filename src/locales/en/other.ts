const other = {
  ...
  taskDetail: {
    ...
    measureVmaf: "VMAF (30s)",
    measureVmafHint: "Compute VMAF mean for the first 30 seconds (input vs output) and aggregate into preset stats.",
    measureVmafDisabled: {
      "no-job": "No job selected.",
      "not-tauri": "Available in desktop (Tauri) only.",
      "not-video": "VMAF is available for video jobs only.",
      "not-completed": "VMAF can be measured for completed jobs only.",
      "missing-input": "Missing input path.",
      "missing-output": "Missing output path.",
    },
  },
