const queue = {
  ...
  feedback: {
    bulkWait: {
      ...
      successDescription: "Queued: {queued}, Processing: {processing}, Ignored: {ignored}.",
      noneTitle: "Bulk pause",
      noneDescription: "No queued or processing jobs selected.",
      errorTitle: "Bulk pause failed",
    },
    bulkResume: {
      successTitle: "Bulk resume",
      successDescription: "Resumed: {count}, Ignored: {ignored}.",
      noneTitle: "Bulk resume",
      noneDescription: "No paused jobs selected.",
      errorTitle: "Bulk resume failed",
    },
    bulkCancel: {
      successTitle: "Bulk stop",
      successDescription: "Stopped: {count}, Ignored: {ignored}.",
      noneTitle: "Bulk stop",
      noneDescription: "No queued, processing, or paused jobs selected.",
      errorTitle: "Bulk stop failed",
    },
    bulkRestart: {
      successTitle: "Bulk restart",
      successDescription: "Restarted: {count}, Ignored: {ignored}.",
      noneTitle: "Bulk restart",
      noneDescription: "No restartable jobs selected.",
      errorTitle: "Bulk restart failed",
    },
    bulkMoveToTop: {
      successTitle: "Move to top",
      successDescription: "Moved: {count}, Ignored: {ignored}.",
      noneTitle: "Move to top",
      noneDescription: "No waiting jobs selected.",
    ...
    bulkDelete: {
      ...
      successDescription: "Removed: {deleted}, Ignored: {ignored}.",
      noneTitle: "Remove from list",
      noneDescription: "No completed/failed/cancelled/skipped jobs selected.",
      partialTitle: "Partially removed",
      partialDescription: "Removed: {deleted}. Terminal selected: {eligible}. Ignored: {ignored}.",
