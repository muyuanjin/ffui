const app = {
  ...
  settings: {
    ...
    presetCardFooterTitle: "Preset footer",
    presetCardFooterDescription:
      'Toggle one-row vs two-row footer. Configure visible stats and ordering in "More settings" (persists across restarts).',
    presetCardFooterLayoutTwoRows: "Two rows",
    presetCardFooterLayoutOneRow: "One row",
    presetCardFooterLayoutButton: "Layout: {layout}",
    presetCardFooterDetailOpen: "More settings…",
    presetCardFooterDetailTitle: "Preset footer · More settings",
    presetCardFooterDetailDescription: "Customize visible stats and ordering.",
    presetCardFooterDetailItemsTitle: "Visible stats & ordering",
    presetCardFooterDetailDragHint: "Drag the handle to reorder.",
    presetCardFooterItemAvgSize: "Avg size",
    presetCardFooterItemFps: "FPS",
    presetCardFooterItemVmaf: "VMAF",
    presetCardFooterItemUsedCount: "Used",
    presetCardFooterItemDataAmount: "Data",
    presetCardFooterItemThroughput: "Throughput",
