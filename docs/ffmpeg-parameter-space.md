...
> 数据源：`https://ffmpeg.org/ffmpeg-all.html`（通过 MCP Context7 `/websites/ffmpeg_ffmpeg-all` 获取，涵盖 2024 最新发布版）。示例引用包括 _Stream Discarding Options_、_HTTP Options_、_image2 muxer options_、_libwebp encoder_, _webm_chunk muxer_, _ts_number_layers_ 等章节。
